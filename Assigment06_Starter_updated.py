...
# JNussb,5.23.2022,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
while (True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        table_1st = Processor.add_data_to_list(task=task, priority=priority, list_of_rows=table_lst)
        continue  # to show the menu

    elif strChoice == '2':  # Remove an existing Task
        task = IO.input_task_to_remove()
        table_1st = Processor.remove_data_from_list(task=task, list_of_rows=table_lst)
        continue  # to show the menu

    elif strChoice == '3':  # Save Data to File
        table_1st = Processor.write_data_to_file(file_name=file_name_str, list_of_rows=table_lst)
